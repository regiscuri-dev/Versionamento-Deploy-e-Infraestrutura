...
const Catalogo=()=>{const itens=getCatalog(); return `
<section class="card">
...
const Formulario=()=>{ setTimeout(()=>document.dispatchEvent(new CustomEvent('route:form')),0); return `
<section class="card">
  ...
  <form id="signupForm" novalidate>
    ...
    <div class="field">
      <label><input id="termos" name="termos" type="checkbox" required /> Li e aceito os termos de uso.</label>
    </div>
...
const NotFound=()=>`<section class="card"><h1>404</h1><p>Página não encontrada. Use o menu acima.</p></section>`;
export const routes={'#/home':{template:Home},'#/catalogo':{template:Catalogo,afterRender:()=>import('./storage.js').then(m=>m.mountCartHandlers())},'#/formulario':{template:Formulario},'#/404':{template:NotFound}};
